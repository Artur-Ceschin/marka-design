...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary: 'bg-bg-birch text-text-charcoal border-[1.5px] border-bg-bark hover:bg-bg-linen',
  ghost:     'bg-green-moss/8 text-green-moss border-[1.5px] border-green-moss/25 hover:bg-green-mist',
  amber:     'bg-amber text-text-white shadow-amber-glow hover:bg-[#b36a2e] active:scale-[0.98]',
  danger:    'bg-bg-birch text-berry border-[1.5px] border-berry/30 hover:bg-berry-pale',
  subtle:    'bg-bg-birch text-text-stone border-[1.5px] border-bg-bark/60 hover:bg-bg-linen',
}
